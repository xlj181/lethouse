...
<head>
    ...
    <script language="JavaScript">
        ...
        function ModifyBySelect(){
            ...
            //alert(12);
            var SelectRows = $("#tp").datagrid('getSelections');
        ...
        function delSingle(id){
            $.messager.confirm('确认提示框', '你真的想删除我吗?', function(result){
                if (result){
                    ...
                    //传参的格式: {"参数名称":值,"参数名称":值}
                    $.post("/deleteT",{"id":id},function(data){
                        if(data.result>0){
                            $("#tp").datagrid('reload'); //刷新
                            //alert("添加成功");
        ...
        function DeleteMore(){
            ...
            //发送异步请求到服务器
            $.post("/deletesT",{"ids":delValue},function(data){
                if(data.result>0){
                    $("#tp").datagrid('reload'); //刷新
                    //alert("添加成功");
