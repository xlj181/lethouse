...
<FORM method=get><INPUT class=text type=text name=keywords>
 <LABEL class="ui-green searchs"><a href="/page/list.jsp" target="_blank">搜索房屋</a></LABEL>
</FORM></DIV></DIV>
...
<H1>${houses.title}</H1>
<DIV class=subinfo><f:formatDate value="${houses.pubdate}" pattern="yyyy-MM-dd"></f:formatDate> </DIV>
<DIV class=houseinfo>
  <p>图片：<img src="http://localhost:80/${houses.path}" width="100" height="75" alt=""></p>
<P>户　　型：<SPAN>${houses.tname}</SPAN></P>
<P>面　　积：<SPAN>${houses.floorage}m<SUP>2</SUP></SPAN></P>
<P>位　　置：<SPAN>${houses.dname}区${houses.sname}</SPAN></P>
<P>联系方式：<SPAN>${houses.contact}</SPAN></P></DIV></DIV>
<DIV class=side>
...
<DIV class=content>
<P>${houses.description}</P></DIV></DIV>
    </DIV></DIV>
